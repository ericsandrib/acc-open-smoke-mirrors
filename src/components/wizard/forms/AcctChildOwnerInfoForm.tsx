...
export function AcctChildOwnerInfoForm() {
  ...
  // SEI custody: render a minimal SEI form heading above the shared sections.
  ...
  return (
    <div className={variant === 'v5' || variant === 'v6' ? 'space-y-9' : 'space-y-7'}>
      ...
      {isSei ? (
        <section id="acct-sei" className="scroll-mt-16">
          <div className={childSectionHeaderClass}>
            <h3 className={childSectionTitleClass}>SEI Custody Account Opening</h3>
          </div>
        </section>
      ) : null}
