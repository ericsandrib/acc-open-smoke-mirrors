...
export function KycChildResultsForm() {
  return (
    <div className="flex flex-col items-center justify-center rounded-lg border border-border bg-muted/30 p-12 text-center">
      ...
      <h3 className="text-base font-semibold leading-snug text-foreground">KYC Results Pending</h3>
      <p className="mt-2 max-w-sm text-[14px] leading-normal text-muted-foreground">
