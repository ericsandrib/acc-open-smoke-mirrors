import { History, User, Users, Workflow, TrendingUp, Sparkles, Mail, FileText, Quote, ListChecks } from 'lucide-react'
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[88vh] max-w-2xl overflow-y-auto">
        ...
        <p className="text-xs text-muted-foreground">Standard report · {r.sections.length} of 13 topics · review, personalize, and enrich before the meeting.</p>
        ...
        <p className="pt-1 text-center text-[11px] text-muted-foreground">Roadmap preview · AI-generated. Advisor reviews before the meeting.</p>
      </DialogContent>
    </Dialog>
  )
}
